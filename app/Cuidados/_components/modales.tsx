...
import { CareCard } from '../types/tipos';
    ...
    export default function Modales({ activeModal, onCloseModal, careCards }: ModalesProps) {
    ...
    return( 
      <>
        {/* Overlay */}
          <div className="fixed inset-0 bg-black/60 backdrop-blur-[8px] z-[1999]" onClick={onCloseModal} />
          ...
          <div className="fixed inset-0 z-[2000] flex items-center justify-center p-5">
            <div className="bg-white rounded-[25px] p-[30px] max-w-[750px] w-full max-h-[90vh] overflow-y-auto relative animate-[modal-slide_0.4s_ease] shadow-modal">
              ...
              <>
                ...
                />
                <div className="text-black leading-[1.7] space-y-3">{modal.body}</div>
                <button
                  onClick={onCloseModal}
